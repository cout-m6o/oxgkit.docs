...
<Highlight color="#0373fc">Attention</Highlight> The [OxGFrame](https://github.com/cout-m6o/OxGFrame) framework provides its own `oxgframe-unity-skill` separately — both can coexist in the skills directory.
