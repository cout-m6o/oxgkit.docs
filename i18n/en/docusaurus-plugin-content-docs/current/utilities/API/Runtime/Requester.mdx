...
| Method | Description |
| :--- | :--- |
| [RequestAudio](#requestaudio) | Requests an AudioClip (cacheable). |
| [RequestTexture2D](#requesttexture2d) | Requests a Texture2D (cacheable). |
| [RequestSprite](#requestsprite) | Requests and creates a Sprite (caches the underlying Texture2D). |
| [RequestBytes](#requestbytes) | Requests file bytes (no caching). |
| [RequestText](#requesttext) | Requests text content (cacheable). |
...
| Method | Description |
| :--- | :--- |
| [InitARCCacheCapacityFor...](#init-arc) | Initializes the **ARC cache** capacity for a resource type (disables that type's LRU cache). |
| [InitLRUCacheCapacityFor...](#init-lru) | Initializes the **LRU cache** capacity for a resource type (disables that type's ARC cache). |
| [RemoveFromARCCacheFor...](#remove-arc) | Removes a URL from a resource type's ARC cache. |
| [RemoveFromLRUCacheFor...](#remove-lru) | Removes a URL from a resource type's LRU cache. |
| [ClearARCCacheCapacityFor...](#clear-arc) | Clears a resource type's ARC cache. |
| [ClearLRUCacheCapacityFor...](#clear-lru) | Clears a resource type's LRU cache. |
| [AutoRemoveFromCaches](#autoremovefromcaches) | Searches all caches and removes the given URL. |
| [ClearAllCaches](#clearallcaches) | Clears all caches. |
| [Release](#release) | Clears and releases all cache containers. |
