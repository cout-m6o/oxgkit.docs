...
| **Source** | [ARCCache.cs](https://github.com/cout-m6o/OxGKit/blob/master/Assets/OxGKit/Utilities/Scripts/Runtime/Cacher/ARCCache.cs), [LRUCache.cs](https://github.com/cout-m6o/OxGKit/blob/master/Assets/OxGKit/Utilities/Scripts/Runtime/Cacher/LRUCache.cs), [LRUKCache.cs](https://github.com/cout-m6o/OxGKit/blob/master/Assets/OxGKit/Utilities/Scripts/Runtime/Cacher/LRUKCache.cs) |
...
The removal handler interface ([IRemoveCacheHandler.cs](https://github.com/cout-m6o/OxGKit/blob/master/Assets/OxGKit/Utilities/Scripts/Runtime/Cacher/Interface/IRemoveCacheHandler.cs)), invoked when a cache entry is **evicted or removed**. Implement it to customize behavior (e.g. return objects to a pool, release resources, or do nothing).
...
The **default removal handler** ([UnityObjectRemoveCacheHandler.cs](https://github.com/cout-m6o/OxGKit/blob/master/Assets/OxGKit/Utilities/Scripts/Runtime/Cacher/Implement/UnityObjectRemoveCacheHandler.cs)): when the cached value is a `UnityEngine.Object`, it calls `UnityEngine.Object.Destroy` on it.
