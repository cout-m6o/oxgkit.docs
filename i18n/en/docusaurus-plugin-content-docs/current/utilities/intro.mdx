...
**Third-party libraries (install them yourself; when used with [OxGFrame](https://github.com/michael811125/OxGFrame), UniTask does not need to be installed separately)**
...
- Use [LWMyBox v1.1.4 or higher](https://github.com/michael811125/LWMyBox), Add https://github.com/michael811125/LWMyBox.git to Package Manager
- Use [OxGKit.LoggingSystem](/docs/loggingsystem/intro), Add https://github.com/michael811125/OxGKit.git?path=Assets/OxGKit/LoggingSystem/Scripts to Package Manager
