...
- Use Right-Click **Create/OxGKit/Input System/Template Input Action.cs (Input Interface For Any)** to implement the InputAction interface (universal signal dispatcher).
- Use Right-Click **Create/OxGKit/Input System/New Input System (Extension)/Template Input Binding Composite.cs (For Unity New Input System)** to create a Binding Composite script for Unity New InputSystem (custom composite input).
